...
const OneBody = () => {
  ...
  useGSAP(() => {
    ...
    gsap.from(".profileImageContainer", {
      duration: 0.67,
      x: 100,
      opacity: 0,
      delay: 1.4,
  ...
  return (
    <>
      <div className="profileImageContainer glass">
        <img src="./wth.jpg" alt="" />
      </div>
          ...
          <div className="profileContainer simpleContainer glass2">
            ...
            <span>
              ...
              >
                ...
                user-friendly interfaces with ReactJS or crafting powerful,
        ...
        <Tilt options={defaultOptions} className="tilt-container">
          <div className="profileContainer simpleContainer glass2">
            ...
            <div className="kiitInfo">
              <img
                style={{
                  filter: "invert(1) drop-shadow(0px 4px 5px yellow)",
            ...
            <div className="kiitInfo">
              <img src="/kiitLogo.png" alt="" className="KiitImage" />
              <div className="description">
